## Features
​Real-time control using joystick.
​Wireless communication via NRF24L01+ modules.
​Arduino Nano-based implementation.
...
## ​Usage
​Follow the setup guide to assemble the hardware and upload the code to the Arduino boards. Ensure correct library installations for seamless operation.be careful about all hardware connection, makesure NRF is conected on 3v3 and GND pin .
